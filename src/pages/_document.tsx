...
export default function Document() {
  return (
    <Html lang="en">
      ...
      <Script strategy="afterInteractive" src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.5/gsap.min.js"></Script>
            ...
            <Script strategy="lazyOnload" src="https://player.vimeo.com/api/player.js"></Script>
            <Script strategy="lazyOnload" src="//code.tidio.co/zjoi0ajovrui5txvitkzweydom4tlltp.js"></Script>
      </Head>
      <body>
        <Main />
        <NextScript />
